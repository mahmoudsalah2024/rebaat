  ...
  <MainLayout>
    <div class="flex flex-col gap-8">
          ...
          <div class="grid gap-4 grid-cols-3">
            <div class="rounded-2xl border border-emerald-200/70 bg-emerald-50 p-4 text-start dark:border-emerald-900/30 dark:bg-emerald-900/20">
              ...
              <p class="mt-2 text-xl font-semibold">
                {{ income }}
                <span class="text-sm font-light text-emerald-600/80 dark:text-emerald-200/80">جنيه</span>
              </p>
            </div>
      ...
      <section class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">آخر التنبيهات</p>
            <p class="mt-2 text-2xl font-bold">تنبيهات</p>
          </div>
        </div>
        <div class="mt-6 grid gap-6 md:grid-cols-2">
          <div class="rounded-2xl border border-slate-200/70 bg-slate-50 p-5 text-start dark:border-slate-800 dark:bg-slate-950">
            <p class="text-lg font-semibold">تعليق المصعد الخارجي</p>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
              سيتم اصلاح المصعد الخارجي بدأً من 20 يوليو
            </p>
            <router-link
              to="/maintenance/[id]"
      ...
      <section class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">الخدمات السريعة</p>
            <p class="mt-2 text-2xl font-bold">خدمات</p>
          </div>
        </div>
      ...
      <section class="rounded-3xl border border-slate-200/70 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">قريباً</p>
            <p class="mt-2 text-2xl font-bold">أقرب مواعيد الصيانة</p>
          </div>
        </div>
        <div class="mt-6 grid gap-4 grid-cols-2">
          <div class="rounded-2xl border border-slate-200/70 bg-slate-50 p-5 text-start dark:border-slate-800 dark:bg-slate-950">
            <p class="text-lg font-semibold">الاثنين 22 يوليو</p>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
              اصلاح ماتور المياه العلوي
            </p>
            <router-link
              to="/maintenance/[id]"
