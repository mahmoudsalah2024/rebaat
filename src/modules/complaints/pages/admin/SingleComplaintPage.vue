        ...
        >
          ...
          <div class="mt-4 grid gap-4 sm:grid-cols-2">
            <div class="rounded-2xl bg-slate-50 px-4 py-3 dark:bg-slate-950">
              ...
              <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">{{ complaint.complaintType }}</p>
            </div>
            <div class="rounded-2xl bg-slate-50 px-4 py-3 dark:bg-slate-950">
              <p class="text-xs font-semibold text-slate-500 dark:text-slate-400">
          ...
          <div class="mt-6 rounded-2xl border border-slate-200/70 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
            <p class="text-xs font-semibold text-slate-500 dark:text-slate-400">
          ...
          <div v-if="complaint.notes" class="mt-4 rounded-2xl border border-emerald-200/70 bg-emerald-50 p-4 dark:border-emerald-900/30 dark:bg-emerald-900/20">
            <p class="text-xs font-semibold text-emerald-700 dark:text-emerald-200">
