    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">{{
              $t('pages.home.accountSummaryLabel') }}</p>
          ...
          <div class="grid gap-4 grid-cols-3">
            <div
              ...
              <p class="mt-2 text-xl font-semibold">
                {{ income }}
                <span class="text-sm font-light text-emerald-600/80 dark:text-emerald-200/80">{{
            ...
            <div
              ...
              <p class="mt-2 text-xl font-semibold">
                {{ outcome }}
                <span class="text-sm font-light text-slate-500 dark:text-slate-400">{{ $t('common.currency.egp')
                }}</span>
              </p>
            </div>
      ...
      <section
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">{{
              $t('pages.home.latestAlertsLabel') }}</p>
            <p class="mt-2 text-2xl font-bold">{{ $t('pages.home.alertsTitle') }}</p>
          </div>
        </div>
        <div class="mt-6 grid gap-6 md:grid-cols-2">
          <div
            class="rounded-2xl border border-slate-200/70 bg-slate-50 p-5 text-start dark:border-slate-800 dark:bg-slate-950">
      ...
      <section
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">{{
              $t('pages.home.fastServicesLabel') }}</p>
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-2">
          <router-link to="/orderMaintenance"
            ...
            <svg class="h-6 w-6 text-emerald-600 dark:text-emerald-300" aria-hidden="true"
          ...
          <router-link to="/makeComplaint"
            ...
            <svg class="h-6 w-6 text-slate-500 dark:text-slate-300" aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/maintenance"
            ...
            <svg class="h-6 w-6 text-slate-500 dark:text-slate-300" aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 640 640">
              <path
      ...
      <section
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">{{ $t('pages.home.comingSoonLabel')
            }}</p>
            <p class="mt-2 text-2xl font-bold">{{ $t('pages.home.upcomingMaintenanceTitle') }}</p>
          </div>
        </div>
        <div class="mt-6 grid gap-4 grid-cols-2">
          <div v-for="(id, index) in 4" :key="index"
            class="rounded-2xl border border-slate-200/70 bg-slate-50 p-5 text-start dark:border-slate-800 dark:bg-slate-950">
